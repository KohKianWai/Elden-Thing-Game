...
/**
 * GoldenNecklace is a class that represents a GoldenNecklace
 *
 * @author Chin Xin Qing
 * @version 1.0.0
 */
public class GoldenNecklace extends Item implements GivableItem {
    private final int affectionValue = 15;
    /**
     * A constructor of GoldenNecklace class
     */
    public GoldenNecklace(){
        super("Golden Necklace", '!', true);
    }
     ...
     * @param giver   the giver who gives the item
    ...
    public String giveItem(Actor npc, Actor giver, GameMap gameMap) {
        ...
        npc.modifyAttribute(NPCUniqueAttributeEnum.AFFECTION, ActorAttributeOperations.INCREASE, affectionValue);
        return npc + " received a " + this + " and increased " + affectionValue + " affection points!";
    }
