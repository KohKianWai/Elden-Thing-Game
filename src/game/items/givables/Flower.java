...
/**
 * Flower is a class that represents a Flower
 *
 * @author Chin Xin Qing
 * @version 1.0.0
 */
public class Flower extends Item implements GivableItem {
    private final int affectionValue = 10;
    /**
     * A constructor of Flower class
     */
    public Flower(){
        super("Flower", 'f', true);
    }
