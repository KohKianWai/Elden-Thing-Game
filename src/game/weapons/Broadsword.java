...
/**
 * Class representing a purchasable weapon called Broadsword.
 * This weapon deals 30 damage points with a 50% chance
 * to hit the target.
 * Broadsword symbol: 'b'
 *
...
public class Broadsword extends WeaponItem implements Purchasable{
     ...
     * Added basic on purchase effect for Broadsword.
     */
    public Broadsword(ArrayList<PurchaseEffect> purchaseEffects, int price) {
        super("Broadsword", 'b', 30, "slashes", 50);
        this.purchaseEffects = purchaseEffects;
        this.price = price;
        this.purchaseEffects.add(
            new AttributesModifierEffect(BaseActorAttributes.HEALTH, ActorAttributeOperations.INCREASE, 10)
        );
    }
